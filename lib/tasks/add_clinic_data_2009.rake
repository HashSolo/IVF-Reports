...
namespace :db do
  desc "Fill database with clinic data from 2009."
  task :add_clinic_data_2009 => :environment do
    #need to import the chromosome CSV file here...
    #Will import the cliic data from 2009
	  CSV.foreach("#{::Rails.root}/lib/tasks/data/clinic_data_2009.csv") do |row|
